...
class Coins {
public:
	// Constructs 'this' Coins object so it has the number of each coin given in the respective
	// parameters.
	...
	// Returns true only if 'this' Coins object has enough of each type of coin to cover a possible
	// extraction of the specific coins in 'coins'.
	...
	// Always prints plural even for 1, e.g. "1 nickels". This is the method called by the output
	// stream inserter below.
	void print(std::ostream& out) const;

	// Allows us to compare Coins objects by equality. You *don't* have to implement anything here,
	// it's generated for you and useful for testing!
...
// coins_required_for_cents() can use math or while loops to decide how to satisfy the need for 
// amount_in_cents. First, take as many quarters, then as many dimes, etc. E.g.,
...
// exmaple, print_cents(3) prints "$0.03", print_cents(509) prints "$5.09" and print_cents(97)
// prints "$0.97".
